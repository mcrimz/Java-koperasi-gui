 ...
 * @author Mahen
 */
public class PanelMenuBarangGuru extends javax.swing.JFrame {

    /**
     * Creates new form PanelMenuBarangGuru
     */
    ...
    String nama_guru = GuruSession.getG_nama_lngkap_guru();
    
    public PanelMenuBarangGuru() {
        initComponents();
        koneksi DB = new koneksi();
        DB.config();
        con = DB.con;
        ...
        tampilComboBox();
        tampilKodePembelian();
        nama_pembeli.setText(nama_guru);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelMenuBarangGuru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
